...
class SetCriterion(nn.Module):
    ...
    def __init__(self, cfg, matcher):
        ...
        """
        super().__init__()
        self.num_classes = cfg.classes - 1
        self.num_points = -1
        ...
        weight_dict = {"loss_ce": cfg.cost_class,
                       "loss_mask": cfg.cost_mask,
                       "loss_dice": cfg.cost_dice}
        aux_weight_dict = {}
        for i in range(cfg.nloops * cfg.dec_layers):
